...
FACT_DATA_TYPES = {
    ...
    "admission.suggested_list_total_count": FactDataType.INTEGER,
    "admission.suggested_list_blank_remark_count": FactDataType.INTEGER,
    "admission.suggested_list_special_count": FactDataType.INTEGER,
