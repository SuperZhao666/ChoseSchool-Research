...
WITH verification_summary AS (
    SELECT
        observation_id,
        COUNT(DISTINCT (
            politics_code || '+' || english_code || '+' ||
            math_code || '+' || professional_code
        )) AS distinct_subject_combinations
